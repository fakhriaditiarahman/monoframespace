...
// 🎯 Why: Calling hooks like `useTransform` inside a `.map()` loop violates React's Rules of Hooks. It can cause hook order instability, memory leaks, and severe re-render bugs.
// 📊 Impact: Prevents memory leaks and ensures stable hook execution, improving long-term page performance.

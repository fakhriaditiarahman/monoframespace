...
// ⚡ Bolt Optimization: Extracted static text array outside the component to prevent
// unnecessary string splitting and garbage collection on every render.
...
function NarrativeWord({ word, i, scrollYProgress }: { word: string, i: number, scrollYProgress: any }) {
  // ⚡ Bolt Optimization: Extracted loop body into separate functional component to ensure
  // Framer Motion's useTransform complies with React's Rules of Hooks.

...
function HeroScene({ scrollYProgress }: { scrollYProgress: any }) {
  ...
  // ⚡ Bolt Optimization: Extracted inline useTransform to component top-level
  // 💡 What: Moved useTransform out of the style prop.
  // 🎯 Why: Calling hooks directly inline within JSX props violates React's Rules of Hooks.
  // 📊 Impact: Ensures stable hook call order, preventing memory leaks or re-render bugs.
...
// ⚡ Bolt Optimization: Extracted inline component/hook from loop body
// 💡 What: Created NarrativeWord component to isolate the useTransform hook.
// 🎯 Why: Calling hooks directly inside array .map() loops violates React's Rules of Hooks
//    as array length/contents could theoretically change, breaking hook order.
// 📊 Impact: Ensures stable hook order, preventing memory leaks and re-render bugs.

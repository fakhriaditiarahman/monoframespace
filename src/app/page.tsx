...
// ⚡ Bolt Optimization: Extracted text.split() outside render loop to prevent GC thrashing on every re-render
const NARRATIVE_WORDS = NARRATIVE_TEXT.split(" ")

// ⚡ Bolt Optimization: Extracted loop item into a separate component to fix React Rules of Hooks violation.
// Calling useTransform inside Array.map() creates unstable hook order and memory leaks.

                ...
                {[
                  ...
                  <motion.div key={i} whileHover={{ scale: 1.05 }} className="w-full flex justify-center group/logo">
                    {/*
                      ...
                      - Using next/image for partner logos allows for better optimization
                      - Mapped width and height properties to appropriate pixel values based on Tailwind classes
                    */}
                    <Image
                      src={partner.url}
                      alt={partner.name}

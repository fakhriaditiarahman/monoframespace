...
function HeroScene({ scrollYProgress }: { scrollYProgress: any }) {
  ...
  // ⚡ Bolt Optimization: Extracted useTransform from inline style to top level to comply with Rules of Hooks
...
/*
  ⚡ Bolt Optimization:
  - Extracted static string and `split()` outside of the component to prevent recalculation on every render.
  - Extracted `NarrativeWord` into a separate functional component to comply with React's Rules of Hooks
    and guarantee stable hook order, resolving potential memory leaks/re-render bugs from calling `useTransform` inside `.map()`.
*/

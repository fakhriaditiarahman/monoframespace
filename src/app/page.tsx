...
/*
  ⚡ Bolt Optimization:
  - Extracted NARRATIVE_TEXT and NARRATIVE_WORDS outside the component to prevent recreating the array and string split operation on every render.
  - Created NarrativeWord component to comply with React's Rules of Hooks (useTransform should not be inside .map).
*/

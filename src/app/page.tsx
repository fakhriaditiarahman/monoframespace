...
// 💡 What: Moved the map body to a separate functional component
// 🎯 Why: Fixes a React Rules of Hooks violation. Calling hooks (useTransform) inside a .map() loop is unsafe and causes hook order instability on re-renders.
// 📊 Impact: Prevents memory leaks and severe React re-render bugs during scroll events.

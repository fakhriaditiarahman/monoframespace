...
function HeroScene({ scrollYProgress }: { scrollYProgress: any }) {
  ...
  // ⚡ Bolt Optimization: Extracted inline hook to top level to guarantee hook order stability
...
// ⚡ Bolt Optimization: Extracted loop body to separate component to prevent Rules of Hooks violation

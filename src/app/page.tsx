...
// ⚡ Bolt Optimization: Extracted static text and words array outside component
// 💡 What: Moved the text array creation outside the component body
// 🎯 Why: Prevents creating the large string and splitting it into an array on every render
...
// 💡 What: Moved the word rendering logic into its own component
// 🎯 Why: Fixes a React Rules of Hooks violation. Calling useTransform inside an array .map() loop is unsafe and can cause memory leaks or re-render bugs.
// 📊 Impact: Ensures stable hook order and correct React behavior, preventing silent bugs.

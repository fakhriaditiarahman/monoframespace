...
// ⚡ Bolt Optimization: Moved static PARTNERS array outside component body
// 💡 What: Extracted the static partner logo configuration to the module scope
// 🎯 Why: Prevents creating a new array and new objects on every single render of the AboutScene
...
// ⚡ Bolt Optimization: Moved static SOCIAL_LINKS array outside component body
// 💡 What: Extracted the static social links configuration to the module scope
// 🎯 Why: Prevents creating a new array and new objects on every single render of the SocialsScene
// 📊 Impact: Minor memory optimization. Reduces garbage collection pressure.
const SOCIAL_LINKS = [
